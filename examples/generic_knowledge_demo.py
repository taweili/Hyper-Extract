"""
GenericKnowledge 使用示例

演示如何使用 GenericKnowledge 类进行知识提取、搜索、保存和加载。
"""
...
def main():
    ...
    # 3. 创建 GenericKnowledge 实例
    print("[2] 创建 GenericKnowledge 实例...")
    ...
    # 9. 加载知识
    print("\n[8] 从文件夹加载知识...")
    new_knowledge = GenericKnowledge(
        data_schema=ArticleKnowledge,
        llm_client=llm,
        embedder=embedder,
    )
