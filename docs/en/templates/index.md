...
- [Finance](domain/finance.md) - Financial document extraction
- [Legal](domain/legal.md) - Legal document extraction
- [Medicine](domain/medicine.md) - Medical document extraction
- [TCM](domain/tcm.md) - Traditional Chinese Medicine templates
...
- [Concepts](../concepts/index.md) - Understand AutoTypes and Methods
