...
class AnimalNode(BaseModel):
    ...
    traits: Optional[str] = Field(description="Key physical traits, genetic markers, or health metrics.")
...
class BreedingRelation(BaseModel):
    ...
    details: Optional[str] = Field(description="Inherited traits, dosage, or specific health observations.")
