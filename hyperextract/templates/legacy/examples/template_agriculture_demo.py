...
这个文件用于测试 hyperextract 农业领域的所有知识模板。
只需要选择模板，程序会自动匹配对应的输入文件。

使用方法：
1. 选择知识模板（修改 TEMPLATE 变量）
2. 运行文件：python examples/template_agriculture_demo.py
"""
...
TEMPLATE_TO_INPUT = {
    # 农业技术手册
    CropGrowthCycle: TEST_SAMPLES_ROOT / "crop_technical_manual.md",
    PestControlHypergraph: TEST_SAMPLES_ROOT / "crop_technical_manual.md",
    # 巡田报告
    FieldObservationList: TEST_SAMPLES_ROOT / "field_scouting_report.md",
    # 土壤分析报告
    SoilNutrientModel: TEST_SAMPLES_ROOT / "soil_analysis_report.md",
    AmendmentPlan: TEST_SAMPLES_ROOT / "soil_analysis_report.md",
}
...
# 农业技术手册
# TEMPLATE = CropGrowthCycle  # 作物生长周期图
