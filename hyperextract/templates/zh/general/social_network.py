...
_PROMPT = """## 角色与任务
你是一位专业的社会关系分析专家，请从文本中提取人物、组织及其相互关系，构建社交网络图。

## 核心概念定义
- **节点 (Node)**：本模板中的"节点"指人物或组织单元，包括人物、组织、机构等类型，用于表示社交网络中的实体。
- **边 (Edge)**：本模板中的"边"指人物/组织之间的社会关系，包括亲属、朋友、同事、师生、上下级、合作、竞争、隶属等二元关系。
...
_NODE_PROMPT = """## 角色与任务
你是一位专业的人物和组织识别专家，请从文本中提取所有人物、组织作为节点。
...
_EDGE_PROMPT = """## 角色与任务
你是一位专业的社会关系提取专家，请从给定节点列表中提取节点之间的相互关系。

## 核心概念定义
- **节点 (Node)**：本模板中的"节点"指人物或组织单元，作为社会关系的参与者。
- **边 (Edge)**：本模板中的"边"指人物/组织之间的社会关系，包括亲属、朋友、同事、师生、上下级、合作、竞争、隶属等二元关系。
