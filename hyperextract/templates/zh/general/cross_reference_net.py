...
_PROMPT = """## 角色与任务
你是一位专业的知识网络分析专家，请从文本中提取概念/条目及其相互引用关系。

## 核心概念定义
- **节点 (Node)**：从文档中提取的概念或条目单元，包括类型如条目、章节、概念、人物、地点等，用于表示知识网络中的实体
- **边 (Edge)**：概念/条目之间的引用关系，包括超链接、引用、参见、相关等二元关系
...
## 核心概念定义
- **节点 (Node)**：从文档中提取的概念或条目单元，包括类型如条目、章节、概念、人物、地点等
...
_EDGE_PROMPT = """## 角色与任务
请从已知节点列表中提取节点之间的引用关系。

## 核心概念定义
- **节点 (Node)**：从文档中提取的概念或条目单元，作为引用关系的参与者
- **边 (Edge)**：概念/条目之间的引用关系，包括超链接、引用、参见、相关等二元关系
