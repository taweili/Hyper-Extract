...
_PROMPT = """你是一位专业的处罚逻辑分析专家。请从文本中提取从“违规行为”到“处理程序”再到“最终结果”的演变路径，构建违规处罚因果链。
...
_NODE_PROMPT = """你是一位专业的处罚节点识别专家。请从文本中提取所有关键节点。
...
_EDGE_PROMPT = """你是一位专业的处罚因果关系识别专家。请从给定节点列表中提取节点之间的因果关系。
